...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_planck_grid(
    CTL_Q,   KC_W,    KC_E,    KC_R,    KC_T,    KC_LBRC, KC_RBRC, KC_Y,    KC_U,    KC_I,    KC_O,    CTL_P,
    ...
    MO_SYM1, KC_RALT, _______, LT_ENT,  KC_TAB,  KC_ESC,  KC_ESC,  KC_BSPC, LT_SPC,  _______, KC_LGUI, MO_SYM2
  ),
  ...
  [_RAISE] = LAYOUT_planck_grid(
    ...
    XXXXXXX, _______, XXXXXXX, _______, _______, _______, _______, _______, _______, XXXXXXX, _______, XXXXXXX
  ),
  ...
  [_ADJUST] = LAYOUT_planck_grid(
    ...
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_INS,  RESET,   RESET,   KC_DEL,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX
  ),
