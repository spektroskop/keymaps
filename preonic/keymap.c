...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_preonic_2x2u( \
        ...
        SFT_Z,   CTL_X,   KC_C,    KC_V,    KC_B,    _______, _______, KC_N,    KC_M,    KC_COMM, CTL_DOT, SFT_SLS,
        _______, KC_LGUI, KC_LALT, MO(1),   KC_ENT,           KC_SPC,           KC_BSPC, KC_INS,  KC_QUOT, TT(1)
    ),
    [1] = LAYOUT_preonic_2x2u( \
        ...
        _______, _______, _______, _______, _______,          _______,          _______, KC_DEL,  KC_GRV,  _______
    ),
};